...
export const checklistRevisions: ChecklistRevision[] = [
  ...
  // Checklist Operacional Passo 1 - Rev 3 (atual, ativa)
  {
    ...
    status: 'active',
    questions: [
      { id: 'q-1', revisionId: 'rev-1-3', text: 'A área está limpa e organizada?', sequence: 1, weight: 10, requiredYesForAdvance: true, answerType: 'binary' },
      { id: 'q-2', revisionId: 'rev-1-3', text: 'Os EPIs estão sendo utilizados corretamente?', sequence: 2, weight: 15, requiredYesForAdvance: true, answerType: 'binary' },
      { id: 'q-3', revisionId: 'rev-1-3', text: 'Os procedimentos operacionais estão atualizados?', sequence: 3, weight: 10, requiredYesForAdvance: false, answerType: 'ternary' },
      { id: 'q-4', revisionId: 'rev-1-3', text: 'Existe quadro de gestão visual atualizado?', sequence: 4, weight: 8, requiredYesForAdvance: false, answerType: 'binary' },
      { id: 'q-5', revisionId: 'rev-1-3', text: 'Os indicadores de produção estão visíveis?', sequence: 5, weight: 12, requiredYesForAdvance: false, answerType: 'binary' },
      { id: 'q-6', revisionId: 'rev-1-3', text: 'A equipe participa ativamente das reuniões?', sequence: 6, weight: 10, requiredYesForAdvance: true, answerType: 'binary' },
      { id: 'q-7', revisionId: 'rev-1-3', text: 'Existe plano de ação para melhorias identificadas?', sequence: 7, weight: 15, requiredYesForAdvance: false, answerType: 'ternary' },
      { id: 'q-8', revisionId: 'rev-1-3', text: 'Os equipamentos estão em bom estado de conservação?', sequence: 8, weight: 10, requiredYesForAdvance: true, answerType: 'binary' },
      { id: 'q-9', revisionId: 'rev-1-3', text: 'As anomalias são registradas e tratadas?', sequence: 9, weight: 10, requiredYesForAdvance: false, answerType: 'binary' },
    ],
  },
