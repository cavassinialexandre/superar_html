...
import { ChecklistsMasonryView } from './checklists-masonry-view'
...
function RevisionEditForm({ revision, open, onSubmit, onCancel }: {
...
export function ChecklistsV3Tab() {
  ...
  const handleSubmitChecklist = async (data: { name: string; status: 'active' | 'inactive' }) => {
    setLoading(true)
