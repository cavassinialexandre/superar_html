/**
 * Variant H -- "Elevated Float Card"
 *
 * Multi-layer shadow depth with floating circular FAB answer selector,
 * decorative shadow plate behind the card, micro-elevation metadata chips,
 * and spring-animated justification sub-card.
...
function ScaleIcon({ size = 10 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3v18" />
      <path d="M5 8l7-5 7 5" />
      <path d="M2 15a5 5 0 0 0 5 5" />
      <path d="M17 20a5 5 0 0 0 5-5" />
...
function getAnswerIcon(answer: AnswerValue): React.FC<{ size?: number }> {
  switch (answer) {
    case 'yes': return CheckCircleIcon
    case 'partial': return AlertTriangleIcon
    case 'no': return XCircleIcon
    case 'na': return MinusCircleIcon
  }
}
...
export function EvalQuestionCardH({
  question,
  index,
  state,
  onAnswer,
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Attachments -- compact with elevated thumbnails */}
        <AttachmentZone
